  ...
  render() {
    return (
      <div className="about-page">
          <Navigation textColor="#86BFFF" scrolledTextColor="white" logo={blueLogo} scrolledLogo={logo} scrolledDistance='120' activePage="About"/>
