...
let worksObject = [
  ...
  },
  {
    ...
    description:
      ...
      benefits: ['-healing on a cellular level', 'promoting restful sleep', 'promoting mental clarity, codependency, and addictions', 'supporting the immune system', 'enhancing spiritual connection', 'relieving depression and anxiety', 'relieving pain and discomfort', 'healing trauma from abuse', 'healing relationship issues and addictions ', 'balancing the chakras ', 'grounding the body'  ],
