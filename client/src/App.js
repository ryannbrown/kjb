...
let worksObject = [
  ...
  },
  {
    ...
    description:
      ...
      moreInfo: `Reiki, or "universal life energy", is an energy healing modality that works gently and powerfully within the chakras and layers of the auric field. Reiki energy healing provides benefits for a person's physical, emotional, mental, and spiritual wellbeing. It is an effective modality for a myriad of issues and imbalances with zero risk. Everything is made up of energy- the spiritual, the physical, thoughts, and emotions. When your energy is healthy, you thrive. Rejuvenating and therapeutic, this session will clear blockages, release stagnant energy, open up energetic pathways, and create a healthy flow of energy through the body, chakras, and auric field. Reiki puts the body in a rest and digest state which accelerates the body's self-healing ability. Benefits from these sessions can include:`,
      benefits: ['healing on a cellular level', 'healing trauma from child abuse, sexual abuse, and physical abuse', 'healing relationship issues, codependency, and addictions', ' healing depression and anxiety', 'healing fear and panic', 'pain reduction and physical recovery', 'promotes restful sleep', 'mental clarity', 'supports the immune system ', 'brings peace and trust in life ', 'balances the chakras and grounds the body'  ],
  ...
  },
  {
    ...
    benefits: [' you feel at war within yourself', 'you struggle with explosive reactions', '  you feel overwhelmed by your emotions', "you aren't sure how to handle triggers", ' you need a safe space to process memories and emotions', 'you desire greater self-acceptance and understanding', ' you need a safe space to process memories and emotions', ' you are seeking guidance' ],
