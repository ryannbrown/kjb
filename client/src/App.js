  ...
  let worksObject = [
    ...
    },
    {
      ...
      description:
        ...
        benefits: ['healing on a cellular level', 'healing unconscious patterns', 'healing trauma from child abuse', ' healing trauma from sexual and physical abuse', 'healing relationship issues, codependency, and addictions', '  healing depression and anxiety', 'healing fear and panic', ' increases creativity, learning abilities, and personal sense of power', 'empowers your goals', 'brings peace and trust in life balances the chakras and grounds the body' ],
    ...
    },
    {
      ...
      description:
        ...
        benefits: [' establishing a healthy relationship with food', ' weight loss', ' alleviating stress', " detoxing", ' feeling energized', 'increasing motivation', 'creating a sustainable healthy lifestyle', ' increasing mental clarity', 'correcting hormonal imbalances',' boosting confidence', '+ much more'  ],
        packages: ['5 pack - $400 (save $100)',  '6 month program (12 sessions) $900 (save $300)'],
